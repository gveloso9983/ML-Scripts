...
Original file is located at
    https://colab.research.google.com/drive/1qXUBgBkrtXeNBZRks-85KV35aF8bdc_6
"""
...
def prepare_data(df_raw):
        ...
        df_raw = df_raw.drop(columns=['High','Low','Volume','Adj Close','Close'])
...
def forecast(model, df, timesteps, multisteps, scaler):
        ...
        for step in range(1, multisteps+1):
            ...
            print("pred:")
            print(pred)
            inp= np.append(inp[0],pred) #adiciona previsão recente ao input
...
n_variate = 1 #1, 2, 3  # number of features used by the model (using conf. cases to predict conf. cases) 
